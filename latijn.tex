...
\multirow{18}{*}{\rotatebox{90}{\textsc{Indicatief}}} & \multirow{6}{*}{\rotatebox{90}{\textsc{Praesens}}} & am-\emph{o} & am-\emph{or} & mone-\emph{o} & mone-\emph{or} & teg-\emph{o} & teg-\emph{or} & audi-\emph{o} & audi-\emph{or} & capi-\emph{o} & capi-\emph{or} \\
 & & ama-\emph{s}   & ama-\emph{ris}  & mone-\emph{s}   & mone-\emph{ris}  & teg-\emph{i}-\emph{s}   & teg-\emph{e}-\emph{ris}  & audi-\emph{s}           & audi-\emph{ris}           & capi-\emph{s}   & cape-\emph{ris} \\
...
\midrule
\multirow{18}{*}{\rotatebox{90}{\textsc{Indicatief}}} & \multirow{6}{*}{\rotatebox{90}{\textsc{Praesens}}} & sum & pos-sum & e-o & fi-o & volo & nolo & malo & fer-\emph{o} & fer-\emph{or} \\
...
\cmidrule{2-11}
 & \multirow{6}{*}{\rotatebox{90}{\textsc{Imperfectum}}} & \emph{era}-m & pot-\emph{era}-m & i-\emph{ba}-m & fi-\emph{eba}-m & vol-\emph{eba}-m & nol-\emph{eba}-m & mal-\emph{eba}-m & fer-\emph{eba}-m & fer-\emph{eba}-r \\
